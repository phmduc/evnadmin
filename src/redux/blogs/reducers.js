...
const {CATEGORY_BLOG_BEGIN, CATEGORY_BLOG_SUCCESS, CATEGORY_BLOG_ERR, BLOGS_UPDATE_BEGIN, BLOGS_UPDATE_ERR, BLOGS_UPDATE_SUCCESS, BLOGS_READ_BEGIN, BLOGS_READ_SUCCESS, BLOGS_READ_ERR, SINGLE_BLOG_BEGIN, SINGLE_BLOG_SUCCESS, SINGLE_BLOG_ERR, BLOGS_CREATE_BEGIN, BLOGS_CREATE_ERR, BLOGS_CREATE_SUCCESS, BLOGS_DELETE_BEGIN, BLOGS_DELETE_ERR, BLOGS_DELETE_SUCCESS } = actions;
